...
urlpatterns = [
    ...
    path('iandctables/',views.iandctables,name='iandctables'),
    path('createquotation/',views.createquotation,name='createquotation'),
    path('historycheck/<str:user_name>',views.historycheck,name='historycheck'),
    ...
    path('editPm_Final/',views.editPm_Final,name='editPm_Final'),
    path('editPm_Margin/',views.editPm_Margin,name='editPm_Margin'),
    path('editPm_Cost/',views.editPm_Cost,name='editPm_Cost'),
    ...
    path('generals/',views.generals,name='generals'),
    path('export_general/',views.export_general,name='export_general'),
    path('editgenerals/',views.editgenerals,name='editgenerals'),
